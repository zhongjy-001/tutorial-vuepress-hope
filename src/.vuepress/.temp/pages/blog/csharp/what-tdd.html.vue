...
<CodeTabs id="216" :data='[{"id":"tab1"},{"id":"tab2"}]'>
...
<CodeDemo id="code-demo-304" type="normal" title="Demo%20%E6%BC%94%E7%A4%BA" code="">
...
<Tabs id="312" :data='[{"id":"标题1"},{"id":"标题2"}]'>
...
<Tabs id="325" :data='[{"id":"标题1"},{"id":"标题2"}]'>
<template #title0="{ value, isActive }">标题1</template>
<template #title1="{ value, isActive }">标题2</template>
<template #tab0="{ value, isActive }">
<p>内容区块</p>
