...
<p>Python建议使用<RouteLink to="/blogs/1.python/20241124-how-anaconda.html">环境管理Anaconda</RouteLink>，当前使用的Python3.8</p>
</blockquote>
...
<p>国内环境如果提示连接不上，可<RouteLink to="/blogs/1.python/20241124-set-mirror.html">参考</RouteLink>设置镜像源。当前使用的（2024-11-24）：</p>
...
<p><strong>下载安装步骤如下：需要下对应浏览器版本的驱动</strong></p>
<p>查看 chrome的版本是最新版本123，所以下载对应的驱动</p>
<p>下载对应的版本：
