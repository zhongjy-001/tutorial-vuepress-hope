<template><div><h2 id="markdown1" tabindex="-1"><a class="header-anchor" href="#markdown1"><span>Markdown1</span></a></h2>
...
<CodeTabs id="228" :data='[{"id":"tab1"},{"id":"tab2"}]'>
...
<CodeDemo id="code-demo-316" type="normal" title="Demo%20%E6%BC%94%E7%A4%BA" code="">
...
<Tabs id="324" :data='[{"id":"标题1"},{"id":"标题2"}]'>
...
<Tabs id="337" :data='[{"id":"标题1"},{"id":"标题2"}]'>
<template #title0="{ value, isActive }">标题1</template>
<template #title1="{ value, isActive }">标题2</template>
<template #tab0="{ value, isActive }">
<p>内容区块</p>
