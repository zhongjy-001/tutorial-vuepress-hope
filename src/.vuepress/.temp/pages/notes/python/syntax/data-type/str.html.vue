<template><div><h2 id="创建字符串" tabindex="-1"><a class="header-anchor" href="#创建字符串"><span>创建字符串</span></a></h2>
...
<h2 id="常用功能" tabindex="-1"><a class="header-anchor" href="#常用功能"><span>常用功能</span></a></h2>
<h3 id="大小写转换" tabindex="-1"><a class="header-anchor" href="#大小写转换"><span>大小写转换</span></a></h3>
<!-- @[code{21-33}](../../demo/var-str-func.py) -->
<h3 id="连接与重复" tabindex="-1"><a class="header-anchor" href="#连接与重复"><span>连接与重复</span></a></h3>
<p>使用 + 进行连接，+ 是字符串的连接符。</p>
<p>使用乘法（*）可实现字符串的重复。</p>
</div></template>
